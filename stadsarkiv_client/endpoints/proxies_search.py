...
async def get(request: Request):
    ...
    query_params_before_search = hooks.before_api_search(query_params=query_params_before_search)
    ...
    query_params_after_search = hooks.after_api_search(query_params=query_params_before_search)
...
async def get_json(request: Request):
    ...
    hooks = get_hooks(request)
    query_params = hooks.before_api_search(query_params=query_params)
