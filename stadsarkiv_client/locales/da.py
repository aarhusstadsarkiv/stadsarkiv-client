da = {
    ...
    "Password": "Password",
    "Password needs to be at least 8 characters long.": "Password skal være mindst 8 tegn langt.",
    ...
    "User already verified. Or the token is not valid.": "Bruger er allerede verificeret. Eller token er ikke længere gyldig.",
    ...
    "You have been verified. You can now login.": "Din konto er nu verificeret. Du kan nu logge ind.",
